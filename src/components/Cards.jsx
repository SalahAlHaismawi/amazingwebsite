    ...
    <div  className="w-full py-[10rem] px-4 bg-white">
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8">
            <div className="w-full shadow-xl flex flex-col py-4 my-4 rounded-lg hover:scale-105 duration-300">
                ...
                <div className="text-center foont-medium">
            ...
            <div className="w-full shadow-xl bg-gray-200 flex flex-col py-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300">
